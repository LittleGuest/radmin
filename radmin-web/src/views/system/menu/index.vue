...
// crud交由presenter持有
const defaultForm = { id: null, title: null, menu_sort: 999, path: null, component: null, componentName: null, i_frame: 0, roles: [], pid: 0, icon: null, cache: 0, hidden: 0, type: 0, permission: null }
export default {
  name: 'Menu',
