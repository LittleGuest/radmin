/*
 ...
 Source Schema         : radmin

 Target Server Type    : MySQL
 Target Server Version : 80020
 File Encoding         : 65001

 Date: 01/01/2021 22:23:29
*/
...
(
    ...
    `column_name`     varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '字段名',
    `column_type`     varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '字段类型',
    `dict_name`       varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '关联字典',
    `extra`           varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '额外信息',
    `form_show`       bit(1)                                                  DEFAULT NULL COMMENT '表单',
    ...
    `list_show`       bit(1)                                                  DEFAULT NULL COMMENT '列表',
    `not_null`        bit(1)                                                  DEFAULT NULL COMMENT '必填',
    `query_type`      varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '查询方式',
    `remark`          varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '字段描述',
    `date_annotation` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '日期注解',
...
(
    ...
    `update_time` datetime     DEFAULT NULL COMMENT '更新时间',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='数据字典';
...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='数据字典详情';
...
INSERT INTO `sys_dict_detail`
VALUES (21, 5, '禁用', 'false', 2, NULL, NULL, NULL, NULL);
COMMIT;
...
(
    ...
    `request_ip`       varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '请求IP地址',
...
VALUES (1, 0, 7, 0, '系统管理', NULL, NULL, 1, 'system', 'system', b'0', b'0', b'0', NULL, NULL, NULL,
...
INSERT INTO `sys_menu`
VALUES (6, 0, 5, 0, '系统监控', NULL, NULL, 10, 'monitor', 'monitor', b'0', b'0', b'0', NULL, NULL, NULL,
...
INSERT INTO `sys_menu`
VALUES (10, 0, 5, 0, '组件管理', NULL, NULL, 50, 'zujian', 'components', b'0', b'0', b'0', NULL, NULL, NULL,
...
INSERT INTO `sys_menu`
VALUES (21, 0, 2, 0, '多级菜单', NULL, '', 900, 'menu', 'nested', b'0', b'0', b'0', NULL, NULL, 'admin',
...
INSERT INTO `sys_menu`
VALUES (36, 0, 7, 0, '系统工具', NULL, '', 30, 'sys-tools', 'sys-tools', b'0', b'0', b'0', NULL, NULL, NULL,
...
INSERT INTO `sys_menu`
VALUES (90, 0, 5, 1, '运维管理', 'Mnt', '', 20, 'mnt', 'mnt', b'0', b'0', b'0', NULL, NULL, NULL, '2019-11-09 10:31:08',
        NULL);
INSERT INTO `sys_menu`
...
(
    `id`               bigint NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `bean_name`        varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'Bean名称',
    `create_time`      datetime                                                DEFAULT NULL COMMENT '创建时间',
    `cron_expression`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'cron表达式',
    `exception_detail` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '异常信息',
    `is_success`       bit(1)                                                  DEFAULT NULL COMMENT '成功',
...
VALUES (1, 2, 'admin', '管理员', '男', '18888888888', '201507802@qq.com', 'avatar-20200806032259161.png',
        '/Users/jie/Documents/work/me/admin/eladmin/~/avatar/avatar-20200806032259161.png', '123456', b'1', 1, NULL,
        'admin', '2020-05-03 16:38:31', '2018-08-23 09:11:56', '2020-09-05 10:43:31');
INSERT INTO `sys_user`
VALUES (2, 2, 'test', '测试', '男', '19999999999', '231@qq.com', NULL, NULL, '123456', b'0', 1, 'admin', 'admin', NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户岗位关联';
